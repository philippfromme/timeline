...
},{"moment":"node_modules/moment/moment.js"}],"src/marathons.json":[function(require,module,exports) {
module.exports = [{
...
var _marathons = _interopRequireDefault(require("./marathons.json"));
...
function updateCountdown() {
  if (countdownDate) {
    overlay.textContent = (0, _date.getDuration)(countdownDate);
  }
}
...
function drawTimeline(options) {
  ...
  data.forEach(function (_ref) {
    ...
    var _drawLabel = drawLabel(title, x),
        _drawLabel2 = _slicedToArray(_drawLabel, 2),
        rect = _drawLabel2[0],
        text = _drawLabel2[1];
  ...
  window.addEventListener('mousemove', function (event) {
    ...
    var align = event.pageX < bounds.width / 2 ? 'left' : 'right';
...
function drawLabel(title, pixels) {
  ...
  (0, _tinySvg.attr)(group, {
    transform: "translate(".concat(pixels + FONT_SIZE / 3.5, " ").concat(height - 2 * PADDING, ")")
  });
...
draw();
},{"min-dash":"node_modules/min-dash/dist/index.esm.js","moment":"node_modules/moment/moment.js","tiny-svg":"node_modules/tiny-svg/dist/index.esm.js","./date":"src/date.js","./marathons.json":"src/marathons.json","./math":"src/math.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
