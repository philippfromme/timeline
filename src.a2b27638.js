...
function getDuration(date) {
  var diff = (0, _moment.default)(date).diff();

  var duration = _moment.default.duration(diff);
  ...
  return [{
    ...
    var count = _ref2.count,
        label = _ref2.label;
    return "".concat(count, " ").concat(label);
  }).join(" ");
}
...
var _runs = _interopRequireDefault(require("./runs.json"));
...
function updateCountdown() {
  if (countdownDate) {
    overlay.innerHTML = "<span>".concat((0, _moment.default)(countdownDate).format("dddd, MMMM Do YYYY"), "</span><br><span>(").concat((0, _date.getDuration)(countdownDate), ")</span>");
  }
}
...
function drawTimeline(options) {
  var data = options.data,
      ...
      start = options.start,
      today = options.today;
  var line = (0, _tinySvg.create)('line');
  (0, _tinySvg.append)(svg, line);
  var _bounds = bounds,
      width = _bounds.width,
...
function drawLabel(title, pixels) {
  ...
  (0, _tinySvg.append)(svg, group);
  (0, _tinySvg.attr)(group, {
    transform: "translate(".concat(pixels + FONT_SIZE / 3.5, " ").concat(y === null ? height - PADDING_BOTTOM - PADDING : y, ")")
  });
  var text = (0, _tinySvg.create)('text');
  (0, _tinySvg.append)(group, text);
  text.textContent = title;
  (0, _tinySvg.attr)(text, {
    fill: 'white',
...
function drawYearLabels(start, end) {
  var years = (0, _date.getYears)(start, end);
  var _bounds3 = bounds,
...
var redrawDebounced = (0, _minDash.debounce)(draw, 100);

var todayDate = (0, _moment.default)(),
    startDate = _moment.default.min(todayDate, (0, _moment.default)('2020-01-01')),
    endDate = (0, _moment.default)('2021-01-01');

var countdownDate = null;
var FONT_SIZE = 20,
    MARKER_SIZE = 5,
    PADDING = 40,
    PADDING_BOTTOM = 120; // query selector instead of ID due to
...
scroll();
},{"min-dash":"node_modules/min-dash/dist/index.esm.js","moment":"node_modules/moment/moment.js","tiny-svg":"node_modules/tiny-svg/dist/index.esm.js","./date":"src/date.js","./runs.json":"src/runs.json","./math":"src/math.js","./styles.css":"src/styles.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
